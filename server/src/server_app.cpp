...
std::string default_graph_json() {
  ...
  "nodes": [
    ...
    {"id": "sp_e", "type": "particle_species", "params": {"preset": "electron", "order": 20}},
    {"id": "sp_p", "type": "particle_species", "params": {"preset": "proton", "order": 20}},
    {"id": "sp_a", "type": "particle_species", "params": {"preset": "alpha", "order": 20}},
